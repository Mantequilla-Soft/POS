const i18n = (() => {
  const translations = {
    en: {
      ...
      'pos.toGoBtn':                  'To-Go',
      'pos.toGoName':                 'Customer Name',
      'pos.toGoNamePlaceholder':      'e.g. Maria',
      'pos.toGoPickupTime':           'Pickup Time (optional)',
      'pos.toGoPickupTimePlaceholder':'e.g. 2:30pm, in 40 min',
      'pos.toGoConfirm':              '📦 Send to Kitchen',
    ...
    es: {
      ...
      'dashboard.metricSales':       'Ventas',
      'dashboard.metricDues':        'Cuotas',
      ...
      'admin.tabProducts':       '🛍️ Productos',
      'admin.tabPayments':       '💳 Pagos',
      'admin.tabMembers':        '👥 Miembros',
      'admin.tabStaff':          '👤 Personal',
      'admin.tabFeatures':       '🍽️ Funciones',
      'admin.tabSettings':       '⚙️ Ajustes',
      'admin.storeIdentity':     'Identidad y Apariencia',
      'admin.publishTitle':      'Publicar Tienda',
      'admin.categoriesTitle':   'Categorías de Productos',
      'admin.categoriesHelp':    'Organiza tu menú en categorías. Aparecen como pestañas de filtro en el POS.',
      'admin.categoryPlaceholder': 'Nombre de nueva categoría…',
      'admin.paymentsTitle':     'Métodos de Pago',
      'admin.paymentsHelp':      'Elige qué métodos de pago pueden aceptar tus cajeros.',
      'admin.staffTitle':        'Personal y Cajeros',
      'admin.staffHelp':         'Gestiona las personas que pueden iniciar sesión y usar el POS.',
      'admin.manageCashiers':    'Gestionar Cajeros →',
      'admin.manageCashiersHelp':'Agrega, elimina o restablece contraseñas de tus cajeros.',
      'admin.featuresTitle':     'Funciones',
      'admin.taxTitle':          'Impuestos',
      'admin.apiServerTitle':    'Servidor API',
      'admin.apiServerHint':     'Cambia solo si usas tu propio servidor.',
      'admin.backupTitle':       'Respaldo y Restauración',
      'admin.openReservations':  'Abrir Reservas →',
      'admin.openHotel':         'Abrir Gestor de Hotel →',
      ...
      'reports.posSales':        'Ventas POS',
      'reports.duesRevenue':     'Cuotas de Membresía',
      'reports.totalIncome':     'Ingreso Total',
      ...
      'inventory.tabMenuStock':         'Stock de Menú',
      ...
      'inventory.menuStockTitle':       'Stock de Artículos del Menú',
      'inventory.menuStockHelp':        'Artículos con "Controlar stock" activado. Toca una fila para ajustar después de un conteo físico o reabastecimiento.',
      'inventory.noMenuStock':          'Ningún artículo del menú tiene seguimiento de stock. Actívalo en la pestaña Productos del admin.',
      'inventory.adjustMenuStockHelp':  'Establece el nuevo conteo de stock (después de un conteo físico o reabastecimiento).',
      'inventory.stockAdjusted':        'Stock actualizado.',
      'admin.trackStock':               'Controlar stock',
      'admin.trackStockHelp':           'El stock baja 1 unidad por cada venta de este artículo.',
      'admin.stockQty':                 'Stock actual (unidades)',
      'pos.stockLeft':                  'disponibles',
      ...
      'closeout.includesDues':        '  ↳ incl. cuotas de membresía',
      'closeout.includesDuesNote':    'Incluye ${amount} en cuotas de membresía cobradas hoy',
      ...
      'closeout.cashCounted':         'Efectivo Contado',
      'closeout.cashVarianceLabel':   'Diferencia de Caja',
      'closeout.varianceNoteLabel':   'Explica la diferencia',
      'closeout.varianceNotePlaceholder': '¿Por qué sobra o falta efectivo?',
      'closeout.cashCountRequired':  'Cuenta el efectivo de la caja antes de enviar.',
      'closeout.varianceNoteRequired': 'Agrega una nota explicando la diferencia de caja antes de enviar.',
      ...
      'closeout.reportVariance':      'Diferencia de Caja',
      ...
      'pos.toGoBtn':                  'Para Llevar',
      'pos.toGoName':                 'Nombre del Cliente',
      'pos.toGoNamePlaceholder':      'ej. María',
      'pos.toGoPickupTime':           'Hora de Recogida (opcional)',
      'pos.toGoPickupTimePlaceholder':'ej. 2:30pm, en 40 min',
      'pos.toGoConfirm':              '📦 Enviar a Cocina',
